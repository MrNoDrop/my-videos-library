...
get.trailerAudios(router, moviesDB, seriesDB);
get.trailerVideos(router, moviesDB, seriesDB);
...
get.trailerThumbnail(router, moviesDB, seriesDB);
get.trailerCover(router, moviesDB, seriesDB);
